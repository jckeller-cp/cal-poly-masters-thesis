...
\begin{itemize}
    \item What elements make up a successful character dialogue\/narrative DSL?
    \item Is a relationship graph a useful way to model world state for writing autonomous
characters?
    \item Can a modernized Praxis-like domain-specific language be effectively used to
model worlds with convincing and engaging characters?
