...
leisure time gaming. \cite{goh_unravelling_2023} With the rise of video games, a rise in interest in video game
...
a practiced medium for millennia now, and are therefore well-understood and easy
...
\begin{itemize}
    ...
    \item Is a structured relationship graph a useful way to model the world state for
    ...
    \item Is a logic-level DSL like Praxis usable for creating convincing
